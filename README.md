...
## 💬 About Me
- 2023년 NEIS 먹통 사태를 계기로, 현장의 니즈를 해결하는 개발자가 되기로 결심했습니다.
- 문제 해결에 진심인 팀플레이어로서, 다른 사람들의 문제를 해결하기 위해 협력하는 것에서 행복을 느낍니다.
- SW 활용 학습 콘텐츠(Minecraft, Goodnotes, Google Education Tools 등)를 개발한 경험이 있어요.
- 언어 교육 전문가로서 영어, 한국어, 러시아어 등에 능통합니다.
