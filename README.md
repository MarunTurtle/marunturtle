...
**배움을 설계하는 교사**로 커리어를 시작했습니다. 🇷🇺 러시아, 🇨🇳 중국, 🇺🇸 미국, 🇰🇷 한국 등 

**다양한 문화권에서 교육을 실험**하며 **문제 해결력**과 **공감 소통 역량**을 길렀습니다.

그 과정에서 **SW를 활용하는 사람**에서 나아가, 

👉 **SW를 직접 설계하는 사람이 되고 싶다**는 열정이 자라났습니다.

--- 

💡 그 결심이 구체화된 계기는 **주변 간호사의 반복적인 행정 업무**였습니다.

지인은 매일 20여 개의 보건복지 사이트를 방문해 **공지사항을 확인하고 정리하는 데만 3시간**을 소요하고 있었습니다.

**Python과 Selenium을 활용해 자동화 프로그램 Medi-모아**를 개발했고, 클릭 한 번으로 수 시간의 업무가 자동화되었습니다.

**내 하루가 바뀌었다**는 간호사의 피드백은 제게 큰 울림을 주었습니다.

📌 사실, 그 전에도 저는 SW를 통한 문제 해결 경험을 쌓아왔습니다.

* 미군 인사과의 **사상자 관리 시스템을 직접 개발**
* **태블릿 기반 e-교과서를 제작**
* **교내 IT 기기 총괄 관리 교사**

**‘Medi-모아’는 그간의 경험이 하나로 연결된 지점**이었고,

👉 **‘내 코드가 누군가의 삶을 실질적으로 바꿀 수 있다’는 확신**을 갖게 되었습니다.

---

🛠 이후 **삼성청년SW-AI아카데미**에서 본격적으로 개발 역량을 갈고닦았습니다.

* Java 교육과정 이수: FE/BE 개발 , DB , 알고리즘 , CS 등   
* 서비스 UI/UX 설계 및 프론트엔드 개발 및 팀장
* 디바운싱·메모이제이션을 활용한 성능 최적화
* GA 기반 사용자 분석 및 실사용자 피드백 기반 개선 주도 
* 최우수상 1회, 우수상 2회, Best Member 2회 수상

👉 현재는 **개발자의 시간을 아끼고, 사용자의 삶을 변화시키는 서비스**를 만드는 데 집중하고 있습니다.
