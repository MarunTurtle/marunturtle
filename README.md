...
## 💬 About Me  
- 2023년 NEIS(국가교육정보시스템) 먹통 사태를 계기로, 수동적인 SW 사용자에서 생산적인 개발자로의 전환을 결심했습니다.  
- 문제 해결에 진심인 팀플레이어로, 함께 고민하고 협력하는 과정에서 즐거움을 느낍니다.  
- 높은 공감 능력을 바탕으로 사용자 경험을 깊이 이해하고, 진짜 필요한 해결책을 찾습니다.  
- 미국, 러시아, 중국 등 다양한 문화권에서 쌓은 경험을 바탕으로, 새로운 기술도 빠르게 익히고 자신 있게 도전합니다.

## 🌟 강점

### 💻 프론트엔드  
- **기술 스택**: HTML, CSS, JavaScript, Vue.js, React, Zustand, React Query, React Router, Tailwind, Bootstrap, Vuetify, Figma  
