# 🏆 안녕하세요! 픽셀 하나도 소중한 개발자, 이재현입니다. 

## 🎯 핵심 가치관 
- **디테일이 전부**: 유저의 니즈 반영부터 UI설계까지 디테일에 강한 개발자
- **도움의 행복**: 타인의 문제를 해결할 때 가장 행복함
- **팀플레이어**: 협력에 진심, 함께 성장을 추구

## 💬 About Me
- 2023년 NEIS(국가교육정보시스템) 먹통 사태를 계기로, 수동적인 SW 이용자에 그치지 않고 생산적인 SW 개발자가 되기로 결심했습니다.
- 문제 해결에 진심인 팀플레이어로서, 다른 사람들의 문제를 해결하기 위해 협력하는 것에서 행복을 느낍니다.
- 높은 공감 능력을 바탕으로, 사용자 경험의 본질을 이해하고 진짜 필요한 해결책을 찾아냅니다
- 미국, 러시아, 중국 등 여러 나라를 넘나든 경험을 바탕으로, 새로운 기술도 빠르게 익히고 자신 있게 도전합니다.

## 🌟 강점

### 프론트엔드
- **프론트 기술 스택**: HTML, CSS, JavaScript, Vue.js, React, Zustand, Tailwind, Bootstrap, Figma
- **사용자 중심 사고**: 교사 출신으로 사용자 중심 사고 탑재. UI/UX 설계와 컴포넌트 기반 설계를 통해 사용자 중심의 인터페이스 구현 경험.
- **백엔드와 원활한 협업**: DB모델, API 명세서 설계 경험. Jira, Git, Notion, Postman Mock Server 활용해 안정적인 코드 관리.
...
### 1. [Dutymate](https://github.com/MarunTurtle/dutymate)

- **프로젝트 소개**:
    - 간호사의 **복잡한 근무표 작성 문제를 해결**하기 위해 개발된 **근무표 자동 생성 및 익명 커뮤니티 서비스.**
    - 알고리즘을 활용한 **자동 근무표 생성, 실시간 규칙 위반 검출, 근무 요청 관리 기능 제공.**
- **주요 특징**:
    - **근무표 자동 생성:** 3주 걸리던 근무표 생성을 **3초로 단축.**
...
- **성과**:
    - 삼성 SW 청년 아카데미 2학기 **프로젝트 우수상(2등) 수상.**
    - 유저 테스트 결과 **100% 요청 반영 및 근무 규칙 준수 성공.**
    - 자체 UI 컴포넌트 디자인 시스템 설계를 통해 **코드 길이 30% 단축 및 유지보수성** 향상.
    - 2025년 3월 기준 **실사용자 200명** 돌파

### 2. [Office Olympics](https://github.com/MarunTurtle/OfficeOlympics)

- **프로젝트 소개**:
    - 직장 내 **팀빌딩과 건강 증진**을 위해 개발된 사무실 맞춤형 웹 서비스.
    - 간단한 운동 챌린지를 통해 **팀워크를 강화하고, 업무 중 활력을 제공.**
- **주요 특징**:
...
- **성과**:
    - **유저 친화적인 인터페이스 설계 & 직관적인 UX 구현.**
    - **서비스 가입 상태 및 이용 패턴에 따른 UI/UX 차별화.**
    - **팀원 간 적극적인 참여 유도를 위한 게이미피케이션 요소 적용.**
    - **삼성 SW 청년 아카데미 1학기 프로젝트 최우수상 수상**

### 3. [Fruit Todo Webapp](https://github.com/MarunTurtle/Fruit_Todo_Webapp)
- **프로젝트 소개**: 인기 과일 게임에서 영감을 받아 Matter.js 물리 엔진을 활용한 인터랙티브 ToDo 앱.
- **주요 특징**:
  - 물리 엔진 기반의 시각 효과
  - 과일 게임 테마를 통해 몰입감 높은 사용자 경험

### 4. [CodeMentor-AI](https://github.com/MarunTurtle/CodeMentor-AI)
- **프로젝트 소개**: OpenAI GPT-4와 Notion API를 활용한 코드 분석 및 피드백 자동 생성 시스템.
- **주요 특징**:
  - 알고리즘 문제 풀이 정리 시간을 절약해주는 자동화 프로그램
  - Notion 페이지에 자동 피드백 업로드

### 5. [Medi-Moa](https://github.com/MarunTurtle/Medi-Moa)
...
### Google Certified Trainer & Educator
- 취득일: 2022.09.09
...
- 📚 **독서/시청 콘텐츠 기록**
  - [독서 기록](https://www.notion.so/2024-6e6f8ac7f1364ad2b997917c26a03f16?pvs=21)
  - [영상/강의 기록](https://www.notion.so/2024-4e5bed7a52f24ffb8cb9222c4a5cf8de?pvs=21)
